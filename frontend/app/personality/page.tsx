            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-8">
                    ...
                    <div className="glass-card p-8 bg-gradient-to-br from-accent/20 to-transparent border-accent/20">
                        ...
                        <button
                            onClick={() => router.push('/improve/Conflict%20Resolution')}
                            className="flex items-center gap-2 font-bold text-xs uppercase tracking-widest text-accent hover:gap-4 transition-all"
                        >
