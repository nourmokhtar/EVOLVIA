...
export function SourceSidebar({
    ...
    const fetchHistory = async () => {
        ...
        try {
            ...
            const apiUrl = process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8000';
            console.error(`[SourceSidebar] Failed to fetch history from ${apiUrl}/api/v1/learn/sessions:`, e);
        } finally {
    ...
    const saveRename = async (sessionId: string) => {
        ...
        try {
            ...
            const apiUrl = process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8000';
            console.error(`[SourceSidebar] Failed to rename session ${sessionId} at ${apiUrl}:`, error);
        } finally {
