...
const avatar_thinking = "https://dwixcmrmtvuunploqdww.supabase.co/storage/v1/object/public/vid/avatar-thinking.mp4";
// "/avatars3/avatar-thinking.mp4";
const avatar_talking = "https://dwixcmrmtvuunploqdww.supabase.co/storage/v1/object/public/vid/avatar-talking.mp4";
// "/avatars3/avatar-talking.mp4";
const avatar_waiting = "https://dwixcmrmtvuunploqdww.supabase.co/storage/v1/object/public/vid/avatar-waiting.png";
// "/avatars3/avatar-waiting.png";
interface Message {
  ...
  useEffect(() => {
    ...
    const unsubscribeHistory = ws.on("history", (event: { history: any[] }) => {
      ...
      const restoredMessages = event.history.map((msg, idx) => ({
        // More robust role mapping
        role: (['user', 'human'].includes(msg.role?.toLowerCase()) ? "user" : "teacher") as "user" | "teacher",
        text: msg.content,
